...
import { Brain, CheckCircle2, ListTodo, Sparkles } from 'lucide-react'

const steps = [
  ['01', 'Dump everything in your mind', 'Capture raw ambitions, links, tasks, and loose thoughts in one place.', Brain],
  ['02', 'AI understands and organizes', 'LifeOS groups, connects, and sequences the work into a living graph.', Sparkles],
  ['03', 'Creates tasks, goals and knowledge graph', 'Your plan becomes visible, structured and ready to execute.', ListTodo],
  ['04', 'Track progress every day', 'Review momentum, protect focus and keep moving forward.', CheckCircle2],
]

export default function HowItWorks() {
  return (
    <section id="how-it-works" className="relative overflow-hidden border-y border-border-subtle bg-bg-surface/40 px-4 py-24 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <h2 className="mt-4 font-display text-3xl font-bold text-text-primary sm:text-4xl">From chaos to clarity in four steps.</h2>
              ...
              <Card className="graph-card min-h-64">
                <div className="relative z-10">
                  <div className="flex items-start justify-between">
                    ...
                    <Icon className="mt-1 text-accent-signal" size={21} />
                  </div>
