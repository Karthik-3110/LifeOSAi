        ...
        <AreaChart data={chartData} margin={{ left: 0, right: 0, top: 10, bottom: 0 }}>
          <defs>
            <linearGradient id="goalGradient" x1="0" x2="0" y1="0" y2="1">
              <stop offset="5%" stopColor="var(--node-task)" stopOpacity={0.45} />
              <stop offset="95%" stopColor="var(--node-task)" stopOpacity={0} />
            </linearGradient>
          </defs>
          ...
          />
          <Area type="monotone" dataKey="tasks" stroke="var(--node-task)" fill="url(#goalGradient)" strokeWidth={3} />
